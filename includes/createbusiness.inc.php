                ...
                if($legalFileError === 0 && $idFileError === 0 && $iconFileError === 0){
                    ...
                    if($legalFileSize < 500000000 && $idFileSize < 500000000 && $iconFileSize < 500000000){
                        ...
                        if(move_uploaded_file($legalFileTmpName, $legalFileDestination) && move_uploaded_file($idFileTmpName, $idFileDestination) && move_uploaded_file($iconFileTmpName, $iconFileDestination)){
                            ...
                            SET business_status = 'active', business_approval = '$business_approval',terms_condition = '$business_termsCondition', datetime_created = '$dateTimeCreated', price = '$business_cost',business_name = '$business_name', business_email = '$business_email', business_category = '$business_fixed', business_subcategory = '$business_subcategory', unit_no = '$business_unit_no',
