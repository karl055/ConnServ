<?php
    ...
    // if ($businessResult = mysqli_query($connect, $businessTblSql)) {
    //     foreach ($businessResult as $businessRow) {
    //         echo $businessRow['business_name'].'<br>';
    //     }
    // }
?>
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="client_approval.html">Client Approvals</a>
                        <a class="collapse-item active" href="business_approval.html">Business Approvals</a>
                    </div>
                </div>
            </li>
                                        ...
                                        <tbody>
                                            <?php 
                                                ...
                                                if ($businessResult = mysqli_query($connect, $businessOwnerTblSql)) {
                                                    foreach ($businessResult as $businessRow) {
                                                        echo $businessRow['user_firstname'].'-';
                                                        echo $businessRow['business_name'].'<br>';
                                                        ?>
