        ...
        <div id="content-wrapper" class="d-flex flex-column" style="margin-left: 250px;">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                ...
                                                $listUserSql = "SELECT * FROM user_tb";

                                                $listUserResult = mysqli_query($connect, $listUserSql);
                                                if($row = mysqli_num_rows($listUserResult)){
                                                    echo $row;
                                                }
                                                ?>
                                            </div>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Total Active Merchants</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                <?php

                                                $listUserSql = "SELECT * FROM business_tb WHERE business_status = 'active'";
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Pending Merchants
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                                                        ...
                                                        $listUserSql = "SELECT * FROM business_tb WHERE business_approval = 'pending'";
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                ...
                                                $listUserSql = "SELECT * FROM admin_tb";
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    ...
                    <span>Copyright &copy; 2019 All Rights Reserved. Connserv Philippines Corporation</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn btn-primary" href="./includes/logout.inc.php?logout">Logout</a>
                </div>
            </div>
        </div>
    </div>
